...
| 항목 | 내용 |
|------|------|
| 도움말 화면 | HelpScreen 생성 (help_screen.dart) |
| 주문 가이드 | 트럭 찾기, 주문하기, 계좌이체 방법 |
| 리뷰 가이드 | 리뷰 작성, 즐겨찾기 기능 설명 |
| 사장님 가이드 | 트럭 등록, 주문 관리, 리뷰 관리 |
| FAQ | 자주 묻는 질문 7개 항목 |
| 문의하기 | GitHub Issues 링크 연결 |
...
**개선 효과**:
- 사용자가 앱 사용법을 쉽게 익힐 수 있음
- 사장님용 가이드로 온보딩 부담 감소
- FAQ로 반복 문의 감소
- GitHub Issues로 피드백 수집 체계화
...
| 항목 | 내용 |
|------|------|
| 개인정보 처리방침 | PrivacyPolicyScreen 생성 |
| 이용약관 | TermsOfServiceScreen 생성 |
| 수집 항목 명시 | 필수/선택 항목 구분 |
| 이용자 권리 명시 | 열람, 정정, 삭제, 처리정지 |
| 책임의 제한 | 서비스 중단, 거래 중개 역할 명시 |
