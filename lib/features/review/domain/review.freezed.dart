...
switch (_that) {
case _Review():
return $default(_that.id,_that.truckId,_that.userId,_that.userName,_that.userPhotoURL,_that.rating,_that.comment,_that.photoUrls,_that.ownerReply,_that.ownerReplyAt,_that.createdAt,_that.updatedAt);}
}
