...
String _$truckDetailHash() => r'292fd8a005d13c53603a320554f1e7cf2cd9e74e';

/// See also [truckDetail].
@ProviderFor(truckDetail)
const truckDetailProvider = TruckDetailFamily();

/// See also [truckDetail].
class TruckDetailFamily extends Family<AsyncValue<TruckDetail>> {
  /// See also [truckDetail].
  const TruckDetailFamily();

  /// See also [truckDetail].
  TruckDetailProvider call(String truckId) {
    return TruckDetailProvider(truckId);
  }

  @override
  TruckDetailProvider getProviderOverride(
    covariant TruckDetailProvider provider,
  ) {
    return call(provider.truckId);
  }
  ...
  @override
  String? get name => r'truckDetailProvider';
}

/// See also [truckDetail].
class TruckDetailProvider extends AutoDisposeFutureProvider<TruckDetail> {
  /// See also [truckDetail].
  TruckDetailProvider(String truckId)
    : this._internal(
        (ref) => truckDetail(ref as TruckDetailRef, truckId),
        from: truckDetailProvider,
        name: r'truckDetailProvider',
        debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
            ? null
            : _$truckDetailHash,
        dependencies: TruckDetailFamily._dependencies,
        allTransitiveDependencies: TruckDetailFamily._allTransitiveDependencies,
        truckId: truckId,
      );

  TruckDetailProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<TruckDetail> Function(TruckDetailRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: TruckDetailProvider._internal(
        (ref) => create(ref as TruckDetailRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeFutureProviderElement<TruckDetail> createElement() {
    return _TruckDetailProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is TruckDetailProvider && other.truckId == truckId;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin TruckDetailRef on AutoDisposeFutureProviderRef<TruckDetail> {
  /// The parameter `truckId` of this provider.
  String get truckId;
}

class _TruckDetailProviderElement
    extends AutoDisposeFutureProviderElement<TruckDetail>
    with TruckDetailRef {
  _TruckDetailProviderElement(super.provider);

  @override
  String get truckId => (origin as TruckDetailProvider).truckId;
}
