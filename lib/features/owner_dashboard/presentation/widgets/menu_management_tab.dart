...
/// Menu management tab content for OwnerManagementScreen
class MenuManagementTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: detailAsync.when(
        loading: () => const Center(child: CircularProgressIndicator(color: AppTheme.mustardYellow)),
        error: (e, _) => Center(
  ...
  void _showAddEditDialog(BuildContext context, WidgetRef ref, MenuItem? existingItem) {
    showDialog(
      context: context,
        ...
        if (_selectedImage != null || (_existingImageUrl?.isNotEmpty ?? false))
          Padding(
            ...
            child: TextButton.icon(
              ...
              label: Text(l10n.removeImage, style: const TextStyle(color: Colors.red, fontSize: 12)),
            ),
          ),
      ],
    );
  ...
  Widget _buildImagePreview() {
    ...
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        Text('이미지 추가', style: TextStyle(color: Colors.white70, fontSize: 14)),
